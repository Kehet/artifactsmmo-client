...
class TasksApi
{
     ...
     * @param  \\KehetArtifactsMMO\ModelSkill|null $skill Skill of tasks. (optional)
     * @param  \\KehetArtifactsMMO\ModelTaskType|null $type Type of tasks. (optional)
     * @param  int|null $page Page number (optional, default to 1)
     * @param  int|null $size Page size (optional, default to 50)
    ...
    public function getAllTasksTasksListGet(
        ?int $min_level = null,
        ?int $max_level = null,
        ?\\KehetArtifactsMMO\ModelSkill $skill = null,
        ?\\KehetArtifactsMMO\ModelTaskType $type = null,
        ?int $page = 1,
        ?int $size = 50,
